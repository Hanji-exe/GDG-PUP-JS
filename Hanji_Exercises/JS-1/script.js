// Using let
let name = "Fahad Hadji Esmael"; // Define a string here, e.g., "Juan Cruz"
let age = 19; // Define a number here, e.g., 30
let isStudent = true; // Define a boolean here, e.g., true or false
let hobbies = ["Drawing", "Reading", "Coding"]; // Define an array here, e.g., ["reading", "gaming", "coding"]
...
const isEmployed = true; // Define a boolean here, e.g., true or false
const favoriteBooks = ["1984","Harry Potter", "History"]; // Define an array here, e.g., ["1984", "Brave New World", "Fahrenheit 451"]
...
// Using var
var city = "Manila City"; // Define a string here, e.g., "New York"
var temperature = 37.5; // Define a number here, e.g., 22.5
var hasPets = false; // Define a boolean here, e.g., true or false
var colors = ["Blue","Black","Maroon"]; // Define an array here, e.g., ["red", "green", "blue"]
